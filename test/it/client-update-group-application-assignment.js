...
if (process.env.OKTA_USE_MOCK) {
  orgUrl = `${orgUrl}/applications-update-group-assignment`;
}
...
describe('client.updateGroupApplicationAssignment()', () => {
  ...
  it('should allow me to assign a group to an application', async () => {
    ...
    try {
      ...
      const assignment = await client.updateGroupApplicationAssignment(createdApplication.id, createdGroup.id);
